...
func(){
    cmd="python main.py -i $1 -d $2 -c $3 -s $4"
    echo $cmd
    $cmd
    echo
}
...
func $instruction $description $conversation $sbml
...
# heat_shock_response
echo python main.py -i Instruction.txt -d '../input/heat_shock_response/heat_shock_response-1.txt ../input/heat_shock_response/heat_shock_response-2.txt' -c Results/heat_shock_response/heat_shock_response_conversation_log.txt -s Results/heat_shock_response/heat_shock_response_SBML_model.xml
